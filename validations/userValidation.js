...
export const cancellationPolicySettingsSchema = [
  body("thirty_days")
    .notEmpty()
    .withMessage("thirty_days is required")
    .isFloat({ min: 0 })
    .withMessage("thirty_days must be a valid number"),
  body("ten_days")
    .notEmpty()
    .withMessage("ten_days is required")
    .isFloat({ min: 0 })
    .withMessage("ten_days must be a valid number"),
  body("seven_days")
    .notEmpty()
    .withMessage("seven_days is required")
    .isFloat({ min: 0 })
    .withMessage("seven_days must be a valid number"),
  body("same_day")
    .notEmpty()
    .withMessage("same_day is required")
    .isFloat({ min: 0 })
    .withMessage("same_day must be a valid number"),
];